...
from shylock.backends import ShylockBackend
from shylock.exceptions import ShylockException

_BACKEND: Optional[ShylockBackend] = None
...
class Lock:
    ...
    def __init__(self, name: str, backend: ShylockBackend = None):
        self.name = name
...
def configure(backend: ShylockBackend):
    """
